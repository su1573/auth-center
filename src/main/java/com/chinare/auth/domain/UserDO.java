...
public class UserDO implements Serializable {
	...
	public String toString() {
		return "UserDO [userId=" + userId + ", username=" + username + ", name=" + name + ", password=" + password
				...
				+ ", gmtModified=" + gmtModified + ", roleIds=" + roleIds + ", applIds=" + applIds + ", sex=" + sex
				+ ", birth=" + birth + ", picId=" + picId + ", liveAddress=" + liveAddress + ", hobby=" + hobby
				+ ", province=" + province + ", city=" + city + ", district=" + district + ", userType=" + userType
				+ ", sAMAccountName=" + sAMAccountName + ", displayName=" + displayName + ", mail=" + mail
				+ ", appEngName=" + appEngName + ", appChnName=" + appChnName + ", distinguishedName="
				+ distinguishedName + ", deptLevel=" + deptLevel + "]";
	}
}
